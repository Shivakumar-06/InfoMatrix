...
const NoData = () => {
  return (
    <StyledWrapper>
      <svg aria-label="loader being flipped clockwise and circled by three white curves fading in and out" role="img" height="20px" width="56px" viewBox="0 0 56 56" className="loader">
